...
Nothing runs this on a schedule. Publication does not depend on it: GitHub Pages serves whatever
is on `main`, so a push is the deployment and the mirror is a convenience copy, rebuilt by hand
